...
class BlenderDatasetBase():
    def setup(self, config, split):
        ...
        self.apply_depth = self.config.apply_depth     # False
        ...
        try:
            ...
            self.k2 = 0.0
            with_distort = False
        # print('with_distort', with_distort)    # True
        ...
        for i, frame in enumerate(meta['frames']):
            ...
            # print('img', img.shape)  # img (1080, 1350, 3)
            ...
            D = np.array([meta['k1'],
                          ...
                          meta['k3'],
                          meta['k4']])
            img[:, :, :3] = cv2.fisheye.undistortImage(img[:, :, :3], K, D, Knew=K)
            # print('im_data', img.shape)    # im_data (1080, 1350, 3)
        ...
        # print('self.all_images', self.all_images.shape)  #self.all_images torch.Size([165, 1080, 1350, 3])
